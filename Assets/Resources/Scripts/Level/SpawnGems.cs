...
public class SpawnGems : MonoBehaviour
{
    ...
    private Dictionary<int, List<Vector2>> positions;
    ...
    private void Awake()
    {
        ...
        positions.Add(0, new List<Vector2> { new Vector2(0f, -9f), new Vector2(-11f, -18f), new Vector2(11f, -20f), new Vector2(31f, -11f), new Vector2(-31f, -11f), new Vector2(-43f, -27f), new Vector2(43f, -27f), new Vector2(43f, -11f), new Vector2(-43f, -11f), new Vector2(43f, 5f), new Vector2(-43f, 5f), new Vector2(0f, 31f), new Vector2(0f, 16f), new Vector2(-25.5f, 5f), new Vector2(25.5f, 5f), new Vector2(20f, 14f), new Vector2(-20f, 14f), new Vector2(-38.5f, 25f), new Vector2(38.5f, 25f), new Vector2(-29f, 25f), new Vector2(29f, 25f), new Vector2(-38.5f, -3f), new Vector2(38.5f, -3f), new Vector2(-24.5f, -5.5f), new Vector2(24.5f, -5.5f), new Vector2(-27.5f, 16f), new Vector2(27.5f, 16f), new Vector2(-13f, 33f), new Vector2(13f, 33f), new Vector2(0f, -27f), new Vector2(-22f, -27f), new Vector2(22f, -27f)});
        positions.Add(1, new List<Vector2> { });
        positions.Add(2, new List<Vector2> { });
        positions.Add(3, new List<Vector2> { });
        LayoutGems(seed);
    }
